...
export const products: Product[] = [
  ...
  {
    id: "aluminum-foil-ffs",
    name: "Aluminum Foil for FFS Applications",
    description:
  ...
  {
    id: "opp-bopp-labels",
    name: "Wrap-Around Application",
    description:
      "OPP & BOPP wrap-around labels for the beverage and dairy industry. These labels provide clarity, durability, and cost-effective branding for bottles and containers, with vibrant print quality and high-speed application readiness.",
    images: ["/images/products/product-03.jpg"],
    categories: ["Dairy", "Food and Beverage"],
  },
  {
